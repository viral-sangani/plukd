import { DEFAULT_TONE_PROMPTS } from './prompts';
...
export const GEMINI_CONFIG = AI_PROVIDERS.GEMINI;

// Extension State
export const STATE = {
    isGenerating: false,
    currentTweetId: null as string | null,
    lastGenerated: null as any,
...
export const DEFAULT_SETTINGS = {
    ...
    includeEmoji: true,
    tone: 'casual',
    customTonePrompts: DEFAULT_TONE_PROMPTS,
    delayRange: '3-8',
    typingSpeed: 'normal'
};
...
export const CSS_CLASSES = {
    // autoReplyWrapper: 'auto-reply-wrapper', // REMOVED
    // autoReplyBtn: 'auto-reply-btn', // REMOVED
